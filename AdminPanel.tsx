...
import { Loader2, Save, Users, Activity, LogIn, Lock, Sparkles, Link as LinkIcon, Plus, X, Key } from 'lucide-react';
                        ...
                        <div className="flex flex-wrap gap-2">
                          {toolsList.map(tool => (
                              <button 
                                  ...
                                  className="px-3 py-1 bg-white border border-gray-200 rounded-full text-xs hover:border-primary hover:text-primary transition-colors shadow-sm flex items-center gap-1"
                              >
                                  <Plus size={10} /> {tool.name}
                              </button>
                          ))}
                        </div>
                        <p className="text-xs text-gray-400 mt-1">Clicking these buttons adds a direct link to the tool in your post.</p>
                    </div>
